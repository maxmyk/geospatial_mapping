...
\thesistitle{ Geospatial System for Visual Navigation} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\textsc{\Large \bfseries Related Work Section}\\[0.5cm] % Thesis type
