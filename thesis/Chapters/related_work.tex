...
morphology has been well studied, the specific topic of scene uniqueness in spatial networks
...
a valuable framework for understanding how spatial arrangements contribute to distinctiveness
...
using OpenStreetMap (OSM) data and the OSMnx toolkit. Boeing uses orientation entropy to
measure the degree of disorder in urban layouts, finding that American cities tend to be
...
However, his research does not extend to how these patterns contribute to geospatial
...
and preliminary data for the future analysis of urban scene uniqueness in Lviv, Lviv Oblast, Ukraine in Figure \ref{fig:urban_analysis_metrics}.
...
with distance from the centre of the street network} - see Figure \ref{fig:variation_length_entropy}.
